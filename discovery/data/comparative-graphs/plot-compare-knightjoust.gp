...
set xlabel "Episode"
set ylabel "Reward"
plot "./knightjoust-g15e200t1e100w0/results-best-champion-interval.txt" using 1:2 title "Best Champion's Policy (20 Trials)" with lines, \
     "./knightjoust-g15e200t1e100w0/results-champions-training-interval.txt" using 1:2 title "Champions over 15 Generations (Training)" with lines, \
