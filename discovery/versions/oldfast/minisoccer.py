...
#    player_on_left = sample_state.index['player_on_left']
    ...
    features = [rl.FeatureFlag('flag-has-ball', player_has_ball),
                rl.FeatureAngle('angle-player-opponent-rightgoalcenter',
                                player, opponent, right_goal_center),
                rl.FeatureDist('dist-player-opponent', player, opponent)]
    
#    features = [
#        rl.FeatureMulti([rl.FeatureFlag('flag-has-ball', player_has_ball),
#                         rl.FeatureAngle('angle-player-opponent-rightgoalcenter',
#                                         player, opponent, right_goal_center),
#                         rl.FeatureDist('dist-player-opponent', player, opponent)])
#        ]
...
def learn_evolutionary():
    ...
    featurizer_multi = rl.FeaturizerMulti(state_vars)
